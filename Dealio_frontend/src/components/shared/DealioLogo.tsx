...
/*
  1. create meeting request from customer builder, cp didn't received notification.
  2. In schedule a visit page display loading symbols if loading cities, projects is taking time.
  3. change date picker view in schedule meeting request, use date picker view from add new project
  4. show cp performance of the project in builder portal either in project or landing page.
  5. implement dark theme for whole application and give option in the settings portal of user.
  6. provide option for cp to see project as customer view(should show project how it will be displayed to customer)
  7. when cp creates meeting request it is not being shown in builders meeting requests.
  8. EST. YEAR field in add new project project identity section should have size of 4.
  9. also sync calendar for builder, cp, customers when booking meeting request customer should see builder avaialble slots in calendar, same for cp as well.
  10. when customer clicks link generated by cp lead is being generated in created profile instead should create in new lead
  11. when cp creates new lead lead is being created in profile created instead of in new lead.
  fix all the above points. resolve one-by-one verify and proceed to next one.
  12. redesign leads&meetings page of builder.
  13. remove dummy data from customer loan applications page, possession tracker page, snagging report page, documents page  and redesign the pages.
14. redesign customers - investements page, loan top up page. */