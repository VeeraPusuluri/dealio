export type MeetingType = 'Site Visit' | 'Interior Consultation' | 'Builder Meeting' | 'Document Review';
...
export const initialMeetings: Meeting[] = [
  ...
  { id: 'MT003', project: 'My Home Avatar', type: 'Interior Consultation', date: '2025-01-10', time: '11:00 AM', location: 'DesignCraft Interiors Studio, Madhapur', status: 'Completed', rating: 5 },
